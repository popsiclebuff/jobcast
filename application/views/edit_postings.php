        ...
        <h3>Details</h3>
         <div class="form-group col-lg-12">
          ...
          <div class="form-group col-lg-12">
            ...
            <div class="col-lg-8">
              <input class="form-control" required type="text" value="<?php echo $val->position; ?>" name="position" placeholder="Position title" >
            </div>
          </div>
           ...
           <div class="form-group col-lg-12">
            ...
            <div class="col-lg-8">
            <textarea placeholder="Qualification" rows="9" cols="64" value="<?php echo $val->about; ?>" name="about"></textarea>
