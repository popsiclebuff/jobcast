			 ...
			 foreach ($notyposted as $job_list) { ?>
						<li class="timeline-grey">
							...
							<div class="timeline-body">
								<?php echo "<b>".$job_list->job_title."</b><br><br>".$job_list->qualification; ?>
								<div class="timeline-footer">

								<!-- <a class="btn red pull-right" href="<?php echo base_url('Main/delete_notif/').''.$user_id.'/'.$job_list->post_id.'/'.$job_list->id.'/del'; ?>">
									Delete <i class="fa fa-close"></i>
									</a> -->

								<?php $applied_db = $this->access_data->applied($user_id, $job_list->post_id, $job_list->id);?>
								<?php 
								    $text = "Apply Now";
									$applied = ""; 
									$title = "Apply Now!";
								...
								?>	
								<a href="<?php echo base_url('Main/book/').''.$user_id.'/'.$job_list->post_id.'/'.$job_list->id."/".$job_list->category_id; ?>" class="btn blue pull-right">
									Book <i class="fa fa-plus"></i>
									</a>
								<a class="btn green pull-right <?=$applied; ?>" href="<?php echo base_url('Main/notify/').''.$user_id.'/'.$job_list->post_id.'/'.$job_list->id."/apply"; ?>" title = "<?=$title?>" >
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				        ...
				        <a href="<?php echo base_url('Main/manage_app/').'manage/'.$apl->apply_id ?>"><button type="button" class="btn btn-success">Accept Application<i class="fa fa-check"></i></button>
						</a>
						<a href="<?php echo base_url('Main/manage_app/').'decline/'.$apl->apply_id ?>"><button type="button" class="btn btn-danger">Decline<i class="fa fa-close"></i></button></a>
